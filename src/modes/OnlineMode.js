...
function OnlineMode({
    ...
    const [socketError, setSocketError] = useState(null); // ✅ surfaces connection errors
    const [inlineError, setInlineError] = useState(null); // ✅ FIX: replaces all alert() calls
    ...
    useEffect(() => {
        ...
        const handleStartGame = (data) => {
            ...
            if (data.tossCaller && setTossCaller) setTossCaller(data.tossCaller);
    ...
    }, [setPlayerDeck, setAiDeck, setIsOnlineGameStarted, setGameMode, setOnlineRole, setPlayerTeam, setAiTeam, setTurn, setWeather, setMoisture, setPitchCondition, setPlayerFranchisePool, setAiFranchisePool, setTossCaller]);
    ...
    return (
        <div className="home">
            <div className="home-container">
                ...
                {/* ✅ FIX: Inline error replaces all alert() calls */}
                {inlineError && (
                    <div style={{
                        ...
                        <button
                            ...
                            style={{ float: "right", background: "none", border: "none", color: "#ff9999", cursor: "pointer", fontWeight: "bold" }}
                        >✕</button>
                    </div>
                )}
